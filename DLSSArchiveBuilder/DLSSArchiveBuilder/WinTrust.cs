                ...
                */
                ...
                switch (lStatus)
                {
                    ...
                    case WinVerifyTrustResult.CERT_E_CHAINING:
                        System.Diagnostics.Debug.WriteLine("CERT_E_CHAINING - A certificate chain could not be built to a trusted root authority.");
                        break;                        
                    ...
                    default:
                        ...
                        System.Diagnostics.Debug.WriteLine("Error is: 0x{0:X}\n", lStatus);
                        break;
                }
